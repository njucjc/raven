...
require (
	...
	github.com/openyurtio/raven-controller-manager v0.0.0-20220711023644-77ab2e8db4d7
...
replace (
	...
	github.com/openyurtio/raven-controller-manager => github.com/njucjc/raven-controller-manager v0.0.0-20220711023644-77ab2e8db4d7
